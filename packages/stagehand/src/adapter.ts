...
export class StagehandAdapter extends Adapter {
  ...
  private options: StagehandAdapterOptions;
  private recordingObserver: any;
   ...
   */
  async connect(stagehand: any): Promise<void> {
   ...
   */
  private convertStagehandTarget(target: any): any {
    if (!target) {
      return '';
    }
