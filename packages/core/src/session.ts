...
export class Session {
  ...
  constructor(options: {
    ...
    this.storageProvider =
      options.storageProvider || new LocalStorageProvider();
  ...
  async capture(target?: any): Promise<void> {
    if (!this.adapter && !target) {
      throw new Error(
        'Either an adapter must be provided at creation time or a target must be provided to capture'
      );
    }
  ...
  async restore(target: any): Promise<void> {
    if (!this.adapter && !target) {
      throw new Error(
        'Either an adapter must be provided at creation time or a target must be provided to restore'
      );
    }
  ...
  async stopRecording(): Promise<void> {
    if (!this.isRecording || !this.adapter || !this.adapter.stopRecording) {
      throw new Error(
        'Recording is not in progress or adapter does not support recording'
      );
    }
  ...
  async playRecording(target: any, options?: PlaybackOptions): Promise<void> {
    ...
    if (!this.adapter && !target) {
      throw new Error(
        'Either an adapter must be provided at creation time or a target must be provided to play recording'
      );
    }
