import { WebDriver, WebElement, Cookie } from 'selenium-webdriver';
import { 
  Adapter,
  BrowserSessionState, 
  Event, 
...
export class SeleniumAdapter extends Adapter {
   ...
   */
  private convertStorageToMap(storage: Record<string, string>, origin: string): Map<string, Map<string, string>> {
