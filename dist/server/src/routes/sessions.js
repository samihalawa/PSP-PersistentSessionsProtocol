...
exports.setupSessionRoutes = setupSessionRoutes;
 ...
 */
function setupSessionRoutes(app, storageProvider) {
    const router = (0, express_1.Router)();
    const controller = new session_controller_1.SessionController(storageProvider);
    /**
     * @swagger
     * /sessions:
     *   get:
     ...
     */
    router.post('/', validators_1.validateSession, controller.createSession);
    /**
     * @swagger
     * /sessions/{id}:
     *   put:
